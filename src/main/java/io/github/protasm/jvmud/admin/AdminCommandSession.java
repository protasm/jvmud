 ...
 * the transport and CLI client; this session receives complete command lines.
 *
 ...
 */
public final class AdminCommandSession {
    ...
    public AdminCommandSession(PrintWriter out) {
     ...
     */
    public static AdminCommandSession attach(PrintWriter out, LPCRuntime runtime, Path root) {
        AdminCommandSession session = new AdminCommandSession(out);
