 ...
 *
 * <p>Provides immutable {@link io.github.protasm.jvmud.compiler.token.Token} records, a strongly typed
 * {@link io.github.protasm.jvmud.compiler.token.TokenType} enumeration that records expected literal classes,
 * and traversal helpers such as {@link io.github.protasm.jvmud.compiler.token.TokenList} for parser
 * consumption.</p>
 *
