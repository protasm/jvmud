...
public final class RuntimeFunctionLiteral implements RuntimeCallable {
    ...
    private final Class<?> helperOwner;
    ...
    public RuntimeFunctionLiteral(String signature, int arity, Object target, String methodName) {
        this(signature, arity, target, methodName, new Object[0], InvocationKind.GENERATED_HELPER, null);
    }
    ...
    public RuntimeFunctionLiteral(
        ...
        this(signature, arity, target, methodName, captures, InvocationKind.GENERATED_HELPER, null);
    }

    /**
     * Creates an executable inline callable whose helper lives on a specific generated class.
     *
     * <p>Inherited LPC methods still run with {@code this} bound to the most-derived object. Binding
     * the helper lookup to the class that emitted the method keeps synthetic helper names from
     * colliding with helpers generated by descendants or flattened parents.</p>
     *
     * @param signature display signature for diagnostics
     * @param arity number of LPC callback arguments expected by the closure body
     * @param target generated object that owns the runtime receiver
     * @param methodName generated helper method name
     * @param captures boxed outer-local values captured by the closure literal
     * @param helperOwner generated class that declared {@code methodName}
     */
    public RuntimeFunctionLiteral(
            String signature,
            int arity,
            ...
            Object[] captures,
            Class<?> helperOwner) {
        this(signature, arity, target, methodName, captures, InvocationKind.GENERATED_HELPER, helperOwner);
    }
    ...
    private RuntimeFunctionLiteral(
        ...
        this(signature, arity, target, methodName, captures, invocationKind, null);
    }
    ...
    public static RuntimeFunctionLiteral namedFunction(String methodName, Object target) {
        ...
        return new RuntimeFunctionLiteral(
                "#'" + methodName, 0, target, methodName, new Object[0], InvocationKind.NAMED_METHOD, null);
    }
    ...
    public Object call(RuntimeContext runtime, Object... args) {
        ...
        if (invocationKind == InvocationKind.NAMED_METHOD) {
            if (!runtime.hasObjectMethod(target, methodName, args != null ? args.length : 0)) {
                return runtime.invokeEfun(methodName, args != null ? args.length : 0, args != null ? args : new Object[0]);
            }
        ...
        try {
            ...
            Class<?> owner = helperOwner != null ? helperOwner : target.getClass();
            Method method = owner.getMethod(methodName, RuntimeContext.class, Object[].class, Object[].class);
