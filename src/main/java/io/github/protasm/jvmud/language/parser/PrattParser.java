...
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_AND;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_BIT_AND;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_BIT_OR;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_BIT_XOR;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_COMPARISON;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_EQUALITY;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_FACTOR;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_NONE;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_OR;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_SHIFT;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_TERM;
import static io.github.protasm.jvmud.language.parser.PrattParser.Precedence.PREC_TERNARY;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_FALSE;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_TRUE;
import static io.github.protasm.jvmud.language.token.TokenType.T_TILDE;

import java.util.HashMap;
import java.util.Map;

import io.github.protasm.jvmud.language.parser.parselet.InfixBinaryOp;
import io.github.protasm.jvmud.language.parser.parselet.InfixIndex;
import io.github.protasm.jvmud.language.parser.parselet.InfixInvoke;
import io.github.protasm.jvmud.language.parser.parselet.InfixPostfixMutation;
import io.github.protasm.jvmud.language.parser.parselet.InfixQualifiedCall;
import io.github.protasm.jvmud.language.parser.parselet.InfixTernary;
import io.github.protasm.jvmud.language.parser.parselet.PrefixIdentifier;
import io.github.protasm.jvmud.language.parser.parselet.PrefixLParen;
import io.github.protasm.jvmud.language.parser.parselet.PrefixLiteral;
import io.github.protasm.jvmud.language.parser.parselet.PrefixArrayLiteral;
import io.github.protasm.jvmud.language.parser.parselet.PrefixClosureArgument;
import io.github.protasm.jvmud.language.parser.parselet.PrefixNumber;
import io.github.protasm.jvmud.language.parser.parselet.PrefixQuotedReference;
import io.github.protasm.jvmud.language.parser.parselet.PrefixString;
import io.github.protasm.jvmud.language.parser.parselet.PrefixSuperCall;
import io.github.protasm.jvmud.language.parser.parselet.PrefixUnaryOp;
