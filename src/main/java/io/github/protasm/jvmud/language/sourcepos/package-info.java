 ...
 *
 * <p>Defines {@link io.github.protasm.jvmud.language.sourcepos.LineMap}, {@link
 * io.github.protasm.jvmud.language.sourcepos.SourcePos}, and {@link io.github.protasm.jvmud.language.sourcepos.SourceSpan}
 * to map offsets to human-friendly file/line/column data, even after preprocessing or generated text
 * insertion.</p>
 *
 * <p>{@link io.github.protasm.jvmud.language.sourcepos.SegmentedSourceMapper} combines multiple {@link LineMap}
 ...
 * for other phases.</p>
 */
package io.github.protasm.jvmud.language.sourcepos;
