package io.github.protasm.jvmud.language.parser;

import static io.github.protasm.jvmud.language.token.TokenType.T_BREAK;
import static io.github.protasm.jvmud.language.token.TokenType.T_AMP_EQUAL;
import static io.github.protasm.jvmud.language.token.TokenType.T_CASE;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_CONTINUE;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_DEFAULT;
import static io.github.protasm.jvmud.language.token.TokenType.T_DO;
import static io.github.protasm.jvmud.language.token.TokenType.T_DOT_DOT;
import static io.github.protasm.jvmud.language.token.TokenType.T_ELSE;
import static io.github.protasm.jvmud.language.token.TokenType.T_EQUAL;
import static io.github.protasm.jvmud.language.token.TokenType.T_FOREACH;
import static io.github.protasm.jvmud.language.token.TokenType.T_IDENTIFIER;
import static io.github.protasm.jvmud.language.token.TokenType.T_IF;
import static io.github.protasm.jvmud.language.token.TokenType.T_IN;
import static io.github.protasm.jvmud.language.token.TokenType.T_INHERIT;
import static io.github.protasm.jvmud.language.token.TokenType.T_FOR;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_RETURN;
...
import static io.github.protasm.jvmud.language.token.TokenType.T_SWITCH;
import static io.github.protasm.jvmud.language.token.TokenType.T_WHILE;
...
import io.github.protasm.jvmud.language.parser.ast.DeclarationModifiers;
import io.github.protasm.jvmud.language.parser.ast.DeclarationModifiers.Visibility;
...
import io.github.protasm.jvmud.language.parser.parselet.InfixParselet;
import io.github.protasm.jvmud.language.parser.parselet.PrefixParselet;
...
import io.github.protasm.jvmud.language.token.TokenClassifier;
...
public class Parser {
     ...
     * io.github.protasm.jvmud.language.parser.type.LPCType#LPCARRAY}. The repeated spelling is
