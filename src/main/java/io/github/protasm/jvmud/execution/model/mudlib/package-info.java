 ...
 * io.github.protasm.jvmud.execution.model.mudlib.MudlibBoundary} records configured boundary objects,
 * lifecycle mappings, temporal hooks, and output preferences. {@link
 * io.github.protasm.jvmud.execution.model.mudlib.MudlibLifecycleEvent} names engine events that a mudlib may
 * translate into its own methods.</p>
 *
 * <p>The classes here are engine contracts. Generated LPC support helpers remain under {@code
 * io.github.protasm.jvmud.language.runtime}.</p>
 */
package io.github.protasm.jvmud.execution.model.mudlib;
