...
class FieldTypeTranspilerTest {
    ...
    @Test void originalTorchCompilesAndUsesNumericFuelWithoutSourceChanges() throws Exception {
        ...
        io.github.protasm.jvmud.language.efun.builtin.CoreEfuns.registerCore(rt, boundary.engineCapabilities());
        rt.registerMudlibBoundary(boundary);
        rt.setParserOptions(io.github.protasm.jvmud.language.parser.ParserOptions.features(boundary.languageFeatures()));
