...
class UntypedMethodTranspilerTest {
    ...
    @Test void originalLysatorChestCompilesWithoutChangingAnyArchiveFile() throws Exception {
        ...
        io.github.protasm.jvmud.compiler.efun.builtin.CoreEfuns.registerCore(runtime, boundary.engineCapabilities());
        runtime.registerMudlibBoundary(boundary);
        runtime.setParserOptions(io.github.protasm.jvmud.compiler.parser.ParserOptions.features(boundary.languageFeatures()));
