...
From a source checkout, with a Java 21-capable JDK, Maven, and Python 3:
...
local player saves, and logs are not included. LP245's original name reservation
...
The website offers only the end-user tar.gz package and its SHA-256 checksum.
