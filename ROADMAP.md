...
- engine/server concepts belong under `src/main/java/io/github/protasm/jvmud/engine/`,
  `src/main/java/io/github/protasm/jvmud/server/`, and
  `src/main/java/io/github/protasm/jvmud/cli/`, while generated bytecode helpers
  remain under `src/main/java/io/github/protasm/jvmud/compiler/runtime/`;
