...
void describe(object viewer) {
  write("Ashenwatch Approach\n");
  write("A military road follows the ridge toward a square keep veiled in slow ");
  write("black sparks. Crown engineers have shored every culvert and marked a safe ");
  write("route for the joint watch, Temple, Collegium, and Company expedition.\n\n");
  write("The Blackstone standing stones are east, and the expedition camp is west.\n");
}
