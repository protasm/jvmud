...
void describe(object viewer) {
  write("Ashenwatch East Tower\n");
  write("A silvered signaling mirror faces the Blackstone wardworks and distant ");
  write("Greyhaven Lantern Tower. Its calibrated frame is sound, though soot has ");
  write("twisted the mirror a few crucial degrees.\n\n");
  write("The great hall is west. Type align to set the ward mirror.\n");
}
...
int align_mirror(mixed ignored) {
  write("You clean the silver face and align it with Blackstone's renewed blue pulse.\n");
