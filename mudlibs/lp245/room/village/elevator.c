...
status go_east() {
  ...
  if (level == 2)
    call_other(this_player(), "move_player", "east#room/village/church");

  if (level == 1)
    call_other(this_player(), "move_player", "east#room/village/wiz_hall");

  if (level == 3)
    call_other(this_player(), "move_player", "east#room/village/attic");
...
void heart_beat() {
  ...
  if (level == 2)
    call_other("room/village/church", "elevator_arrives", 0);
