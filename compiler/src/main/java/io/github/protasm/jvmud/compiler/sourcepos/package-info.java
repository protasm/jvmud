 ...
 *
 * <p>Defines {@link io.github.protasm.jvmud.compiler.sourcepos.LineMap}, {@link
 * io.github.protasm.jvmud.compiler.sourcepos.SourcePos}, and {@link io.github.protasm.jvmud.compiler.sourcepos.SourceSpan}
 * to map offsets to human-friendly file/line/column data, even after preprocessing or generated text
 * insertion.</p>
 *
 * <p>{@link io.github.protasm.jvmud.compiler.sourcepos.SegmentedSourceMapper} combines multiple {@link LineMap}
