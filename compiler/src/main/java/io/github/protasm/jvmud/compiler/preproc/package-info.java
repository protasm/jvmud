 ...
 * preserving mappings back to original files via {@link io.github.protasm.jvmud.compiler.sourcepos.LineMap}
 * and {@link io.github.protasm.jvmud.compiler.sourcepos.SourceSpan} data.</p>
 *
 * <p>Exposes pluggable {@link io.github.protasm.jvmud.compiler.preproc.IncludeResolver} strategies so callers
