...
/* Optional */
void set_race(r) { race = r; }
/* optional */
void set_hp(hp) { max_hp = hp; hit_point = hp; }
/* optional */
void set_ep(ep) { experience = ep; }
/* optional */
void set_al(al) {
...
/* optional */
void set_long(lo) { long_desc = lo; }
/* optional */
void set_wc(wc) { weapon_class = wc; }
/* optional */
void set_ac(ac) { armor_class = ac; }
/* optional */
...
void set_chat_chance(c) {
    chat_chance = c;
}

void remove_chat(str) {
    chat_nr -= 1;
...
void set_a_chat_chance(c) {
    a_chat_chance = c;
}

void remove_a_chat(str) {
    a_chat_nr -= 1;
    head = call_other(a_chat_head,"remove_chat",str);
}


void load_a_chat(str) {
    object old;
