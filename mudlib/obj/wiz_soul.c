...
status id(str) { return str == "wiz_soul" || str == "ND"; }
...
int valid_read(str) { return call_other(myself,"valid_read",str); }

int valid_write(str) { return call_other(myself,"valid_write",str); }
