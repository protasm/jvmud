...
status open(mixed str) {
  ...
  if (call_other("room/village/elevator", "query_level", 0) != 2) {
...
status push(mixed str) {
  ...
  if (call_other("room/village/elevator", "call_elevator", 2))
    lamp_is_lit = 1;
...
status west() {
  if (call_other("room/village/elevator", "query_door", 0) ||
    call_other("room/village/elevator", "query_level", 0) != 2) {
